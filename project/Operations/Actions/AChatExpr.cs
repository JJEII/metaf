...
namespace Metaf
{
    public class AChatExpr : Action
    {
        ...
        override public void ImportFromMetAF(ref FileLines f)
        {
            ...
            try { _a_chExpr = match.Groups["s"].Value[1..^1]; } // length is at least 2; remove delimiters
        ...
        override public void ExportToMetAF(ref FileLines f)
        {
            ...
            f.line.Add($"{new string('\t', depth)}{typeid} {Rx.oD}{_a_chExpr}{Rx.cD}{SpellIdsText}");
        }
    }
}