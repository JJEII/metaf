...
namespace Metaf
{
    public class AChat : Action
    {
        ...
        override public void ImportFromMetAF(ref FileLines f)
        {
            ...
            try { _a_chat = match.Groups["s"].Value[1..^1]; } // length is at least 2; remove delimiters
        ...
        override public void ExportToMetAF(ref FileLines f)
        {
            ...
            f.line.Add($"{new string('\t', depth)}{typeid} {Rx.oD}{_a_chat}{Rx.cD}{SpellIdsText}");
        }
    }
}