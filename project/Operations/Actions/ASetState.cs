...
namespace Metaf
{
    public class ASetState : Action
    {
        ...
        override public void ImportFromMetAF(ref FileLines f)
        {
            ...
            try { _a_state = match.Groups["s"].Value[1..^1]; } // length is at least 2; remove delimiters
        ...
        {
            f.line.Add($"{new string('\t', depth)}{typeid} {Rx.oD}{_a_state}{Rx.cD}");
        }
    }
}