...
namespace Metaf
{
    public class CMainSlotsLE : Condition
    {
        ...
        override public void ImportFromMet(ref FileLines f)
        {
            ...
            try { _slots = Int32.Parse(f.line[f.L++]); }
        ...
        override public void ImportFromMetAF(ref FileLines f)
        {
            ...
            try { _slots = Int32.Parse(match.Groups["i"].Value); }
        ...
        {
            f.line.Add($"{new string('\t', depth)}{typeid} {_slots}");
        }
    }
}