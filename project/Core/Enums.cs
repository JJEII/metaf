...
namespace Metaf
{
    ...
    public enum M_NavTypeID
    { // These parallel the NavTypeID list, but are used in the metaf file, for NAV types, by NAME, not by value
        circular = 1,
        linear = 2,
        follow = 3,
        once = 4
    ...
    public enum M_NTypeID
    { // These parallel the NTypeID list, but are used in the metaf file, for NAV node types, by NAME, not by value
        flw = -2,
        Unassigned = -1,
        pnt = 0,
